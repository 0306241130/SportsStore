...
namespace SportsStore.Infarstructure
{
    public class FakeProductRepository : IProductRepository
    {
        public IQueryable<Product> Products => new List<Product>
        {
            ...
            new Product { ProductID = 4, name = "Running shoes", Description = "A pair of running shoes", Price = 95, Category = "Running" , ImageUrl = "/images/sandro-schuh-HgwY_YQ1m0w-unsplash.jpg"}
        }.AsQueryable();
    }
}
